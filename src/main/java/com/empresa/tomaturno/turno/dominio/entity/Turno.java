...
public class Turno {
    ...
    public Turno reasignarA(Long nuevoId, Long idSucursalDestino, Long idColaDestino, Long idDetalleValido) {
        ...
        return Turno.of(new Builder()
                ...
                // +1s en vez de reusar fechaCreacion: evita choque de PK (idSucursal+fechaCreacion+codigoTurno)
                // con el turno original, preservando el orden de llegada en vez de mandarlo al final con now()
