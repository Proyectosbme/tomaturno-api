package com.empresa.tomaturno.cola.dominio.vo;
...
public class Auditoria {
    ...
    public void validarCreacion() {
        if (this.usuarioCreacion == null || this.fechaCreacion == null) {
            throw new IllegalArgumentException("No tiene usuario de creacion y fecha de creacion revisar ");
        }
    }

    public void validarModificacion() {
        if (this.usuarioModificacion == null || this.fechaModificacion == null) {
            throw new IllegalArgumentException("No tiene usuario de modificacion y fecha de modificacion revisar ");
        }
    }
