package com.empresa.tomaturno.detallecolaxpuesto.dominio.validador;

import java.util.function.Function;

/**
 * Validador fluido genérico de nulos/vacíos. No fija un tipo de excepción propio:
 * cada módulo pasa su propia XxxValidationException (ej. DetalleColaxPuestoValidationException::new)
